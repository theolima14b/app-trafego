...
export default function Home() {
  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-[60vh] text-center">
      ...
      <h1 className="text-5xl font-bold mb-8 text-gray-100">Vite + React</h1>
      <div className="p-8">
        <button 
        ...
        <p className="mt-4 text-gray-400">
          Edit <code className="bg-gray-800 text-gray-100 px-2 py-1 rounded">src/pages/Home.jsx</code> and save to test HMR
        </p>
      </div>
